...
class EvalConfig:
    def __init__(self):
        ...
        self.checkpoint_path = r"C:\Users\Gading\Downloads\Research\Models\DenseNet121\checkpoints\densenet121_teacher_20250325_160534_best.pth"
...
####################################
def analyze_results(y_true, y_pred, class_names, config):
...
def main():
    ...
    try:
        ...
        # 4. Generate metrics
        accuracy = analyze_results(targets, predictions, config.classes, config)
